            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
            	            <li><a href="?app=trainingform">Lập khung chương trình đào tạo Khóa</a></li>
                            <li><a href="?app=planning_training">Lập kế hoạch đào tạo Khóa</a></li>
                            <li class="divider"></li>
                            <li><a href="?app=classsubject">Lập kế hoạch lớp môn học</a></li>
                            <li><a href="?app=printclasssubject">In danh sách lớp môn học</a></li>
                            <li><a href="?app=markcomponent">Nhập điểm thành phần</a></li>
                            <li class="divider"></li>
                            <li><a href="?app=essay_check_condition">Xét điều kiện bảo vệ luận văn</a></li>
                            <li><a href="?app=council">Thành lập hội đồng bảo vệ luận văn</a></li>
                            <li><a href="?app=essaymark">Nhập điểm bảo vệ luận văn</a></li>
                            <li><a href="#">Xét duyệt tốt nghiệp</a></li>
                            <li class="divider"></li>
                            <li><a href="?app=calculate_mark">Tổng hợp điểm (Tính điểm)</a></li>
                            <li><a href="?app=printmark">In bảng điểm</a></li>
                            <li class="divider"></li>
                            <li class="disabled"><a href="#">Khoá điểm</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Quản lý thi <span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="?app=exammain">Tạo đợt thi</a></li>
                            <li><a href="?app=exam_list">Lập danh sách thi</a></li>
							<li><a href="?app=exam_room">Chia phòng thi</a></li>
                            <li><a href="?app=examstatus">Cập nhật tình trạng vắng thi</a></li>
                            <li><a href="?app=exam_beat">Đánh phách - Chia túi bài chấm</a></li>
                            <li class="divider"></li>
                            <li><a href="?app=exammarklist">Nhập điểm thi theo danh sách</a></li>
                            <li><a href="?app=exammarkbag">Nhập điểm thi theo số phách</a></li>
                        </ul>
                    </li>
                </ul>
                <?php
