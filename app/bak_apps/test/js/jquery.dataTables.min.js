...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Trang đầu",sLast:"Trang cuối",sNext:"Trang kế",sPrevious:"Trang trước"},sEmptyTable:"No data available in table",sInfo:"Hiển thị _START_ đến _END_ trong tổng số _TOTAL_ bản ghi",sInfoEmpty:"Hiển thị 0 đến 0 trong tổng số 0 bản ghi",sInfoFiltered:"(được lọc từ tổng số _MAX_ bản ghi)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Hiển thị _MENU_ bản ghi mỗi trang",sLoadingRecords:"Đăng tải...",sProcessing:"Đăng xử lý...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không tìm thấy dữ liệu phù hợp"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,
